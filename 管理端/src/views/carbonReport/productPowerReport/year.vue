  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="年份">
        <el-date-picker v-model="queryParams.params.beginProductDate" size="small" style="width: 240px" value-format="yyyy-MM-dd" type="year" placeholder="选择开始年份"></el-date-picker>
        -
        <el-date-picker v-model="queryParams.params.endProductDate" size="small" style="width: 240px" value-format="yyyy-MM-dd" type="year" placeholder="选择结束年份"></el-date-picker>
      </el-form-item>
      <el-form-item>
