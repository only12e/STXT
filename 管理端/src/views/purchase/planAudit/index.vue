  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="1000px" append-to-body>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button v-no-more-click v-if="form.applyStatus!='2'" type="primary" >通 过</el-button>
        <el-button v-no-more-click v-if="form.applyStatus!='2'" type="warning" >驳 回</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        listPlan4Audit(this.queryParams).then(response => {
      ...
      submitForm(status) {
        ...
        this.$refs["form"].validate(valid => {
          if (valid) {
            auditPlan(this.form).then(response => {
