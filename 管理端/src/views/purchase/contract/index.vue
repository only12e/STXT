      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button v-no-more-click v-if="scope.row.auditStatus!='1'&&scope.row.applyStatus!='1'" size="mini" type="text"
            icon="el-icon-delete" @click="handleDelete(scope.row)" v-hasPermi="['purchase:contract:remove']">删除
          </el-button>
        </template>
      </el-table-column>
    </el-table>
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button v-no-more-click v-if="form.auditStatus!='1'&&form.applyStatus!='1'" type="primary" icon="el-icon-plus"
              size="mini" @click="handleAddScmPurchaseContractDetail">添加
            </el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button v-no-more-click v-if="form.auditStatus!='1'&&form.applyStatus!='1'" type="danger" icon="el-icon-delete"
              size="mini" @click="handleDeleteScmPurchaseContractDetail">删除
            </el-button>
          </el-col>
        </el-row>
