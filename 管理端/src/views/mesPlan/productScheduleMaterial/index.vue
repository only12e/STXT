<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="productScheduleMaterialList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="排产编号" align="center" prop="scheduleId" />
      <el-table-column label="物料" align="center" prop="materialId" />
      <el-table-column label="需求数量" align="center" prop="requireQuantity" />
      <el-table-column label="已用数量" align="center" prop="usageQuantity" />
      <el-table-column label="剩余数量" align="center" prop="leftQuantity" />
