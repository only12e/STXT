<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button v-no-more-click v-hasPermi="['mesModel:factoryModel:add']" type="primary" plain icon="el-icon-plus"
          size="mini" @click="handleAdd">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button v-no-more-click v-hasPermi="['mesModel:factoryModel:edit']" type="success" plain icon="el-icon-edit"
          size="mini" :disabled="single" @click="handleUpdate">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button v-no-more-click v-hasPermi="['mesModel:factoryModel:remove']" type="danger" plain
          icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete">删除</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="factoryModelList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button v-no-more-click v-hasPermi="['mesModel:factoryModel:edit']" size="mini" type="text"
            icon="el-icon-edit" @click="handleUpdate(scope.row)">修改</el-button>
          <el-button v-no-more-click v-hasPermi="['mesModel:factoryModel:remove']" size="mini" type="text"
      ...
      <el-form ref="form" :model="form" :inline="true" :rules="rules" label-width="100px">
        ...
        <el-form-item label="产品" prop="materialName">
          <el-input v-model="form.materialName" placeholder="请选择产品" disabled>
            <el-button slot="append" v-no-more-click @click="handleSelectMaterial">选择</el-button>
          </el-input>
        </el-form-item>
        ...
        <el-table ref="mesFactoryModelDetail" :data="mesFactoryModelDetailList"
          :row-class-name="rowMesFactoryModelDetailIndex"
          @selection-change="handleMesFactoryModelDetailSelectionChange">
...
export default {
  ...
  methods: {
    handleEquipChange(val, index) {
      if (val) {
        const row = this.mesFactoryModelDetailList[index]
